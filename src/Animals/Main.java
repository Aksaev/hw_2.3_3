...
public class Main {
    public static void main(String[] args) {
        ...
        Herbivores horse = new Herbivores("Лошадь", 3, "поле", 60, "травой");
        ...
        Predators hyena = new Predators("Гиена", 4, "саванне", 40, "больных и слабых животных");
        Predators tiger = new Predators("Тигр", 10, "тропическом лесу", 50, "животных");
        Predators bear = new Predators("Медведь", 7, "лесу", 40, "животных и рыбу");
